...
class ProdEvenModulo50(Process):
    ...
    instance_counter = 0  # Licznik instancji

    def __init__(self):
        ProdEvenModulo50.instance_counter += 1
        self.instance_id = ProdEvenModulo50.instance_counter
        super().__init__()
    ...
    def __str__(self):
        return f'A1 {self.instance_id}'  # Zwracamy numer instancji
...
class ProdOddModulo50(Process):
    ...
    def __init__(self):
        ProdOddModulo50.instance_counter += 1
        self.instance_id = ProdOddModulo50.instance_counter
        super().__init__()
    ...
    def __str__(self):
        return f'A2 {self.instance_id}'  # Zwracamy numer instancji
...
class ConsEven(Process):
    ...
    def __init__(self):
        ConsEven.instance_counter += 1
        self.instance_id = ConsEven.instance_counter
        super().__init__()
    ...
    def __str__(self):
        return f'B1 {self.instance_id}'  # Zwracamy numer instancji
...
class ConsOdd(Process):
    ...
    def __init__(self):
        ConsOdd.instance_counter += 1
        self.instance_id = ConsOdd.instance_counter
        super().__init__()
    ...
    def __str__(self):
        return f'B2 {self.instance_id}'  # Zwracamy numer instancji
...
def run(given_process: Process, all_processes):
    ...
    while True:
        ...
        if not process.condition():
            ...
            print(f"{str(process)}: Zwolniłem semafor główny")
            mutex.V()
